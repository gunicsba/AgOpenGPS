...
namespace AgOpenGPS
{
    public partial class FormSteerWiz : Form
    {
        ...
        private void FormSteer_Load(object sender, EventArgs e)
        {
            ...
            mf.vehicle.goalPointLookAheadMult = Properties.ToolSettings.Default.setVehicle_goalPointLookAheadMult;
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            else if (toSend251 && counter251 > 3)
            {
                ...
                mf.p_251.pgn[mf.p_251.minSpeed] = unchecked((byte)(Properties.VehicleSettings.Default.setAS_minSteerSpeed * 10)); //0.5 kmh
        ...
        private void btnLoadDefaults_Click(object sender, EventArgs e)
        {
            ...
            Properties.VehicleSettings.Default.setAS_countsPerDegree = 100;

            Properties.VehicleSettings.Default.setAS_ackerman = 100;

            Properties.VehicleSettings.Default.setAS_wasOffset = 0;
            ...
            Properties.VehicleSettings.Default.setVehicle_wheelbase = 2.8;

            Properties.VehicleSettings.Default.setVehicle_trackWidth = 1.9;

            Properties.VehicleSettings.Default.setVehicle_antennaPivot = 0.1;

            Properties.VehicleSettings.Default.setVehicle_antennaHeight = 3;

            Properties.VehicleSettings.Default.setVehicle_antennaOffset = 0;
